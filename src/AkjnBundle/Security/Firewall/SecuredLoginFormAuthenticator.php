...
//            $passwordValid = $this->encoderFactory->getEncoder($user)->isPasswordValid($token->getCredentials(), $user->getPassword(), $this->browserSalt);
            $encode = $this->encoderFactory->getEncoder($user)->encodePassword($token->getCredentials(), $user->getSalt());            
//            dump($passwordValid);
//            dump($token->getCredentials());
//            dump($this->encoderFactory->getEncoder($user)->encodePassword($token->getCredentials(), $user->getSalt()));
//            dump($this->encoderFactory->getEncoder($user));
//            dump($user->getPassword());
//            dump($this->browserSalt);
//            die;

            if ($encode == $user->getPassword()) {
